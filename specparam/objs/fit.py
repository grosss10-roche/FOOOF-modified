...
class SpectralModel():
    ...
    def _simple_ap_fit(self, freqs, power_spectrum):
        ...
        kne_guess = [self._ap_guess[1]] if self.aperiodic_mode == 'knee' or self.aperiodic_mode == 'knee_expo' else []
        ...
        slope_guess = [self._ap_guess[3]] if self.aperiodic_mode == 'knee_expo' else []
        ...
        elif self.aperiodic_mode == 'knee_expo':
        ...
        guess = np.array(off_guess + kne_guess + exp_guess + slope_guess)
